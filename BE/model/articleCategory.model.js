...
const articleCategorytSchema = new mongoose.Schema({
    title: String,
    description: String,
    parent_id: {
        type: String,
...
const ArticletCategory = mongoose.model("Article-category", articleCategorytSchema, "article-category")

module.exports = ArticletCategory;